...
class ScheduleSystem(discord.ui.View):
    ...
    def __init__(self, timeout, version):
    ...
    async def on_timeout(self):
        ...
        embed.set_footer(text=f"天馬咲希 v{self.version} - by DiceOnMat")
...
class ScheduleCog(commands.Cog, name='schedule'):
    ...
    async def schedule_system(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.response.send_message(embed=embed, view=ScheduleSystem(timeout=30, version=self.bot.version))
"""
